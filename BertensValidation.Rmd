...
library(ggthemes)
library(naniar)
eclipse.raw <- read_csv("eclipse.csv") %>% filter (VISIT == "1 Year") %>% select (id = SUBJECT_ID, Age = AGE, sex = SEX, 
                                               fev1 = FEV1PSPC) %>%
...
AcceptROCSev <- roc(predictor=externalResults$predicted_severe_exac_probability_oldMethod, response = externalResults$hadSevereExac,
    plot = T, ci=T, print.auc=TRUE,  boot.n=1000, ci.alpha=0.95, stratified=FALSE, show.thres=TRUE, grid=TRUE)                          

HistoryROCSev <- roc(predictor=externalResults$obsExac_yr1, response = externalResults$hadSevereExac,
                             plot = T, ci=T, print.auc=TRUE,  boot.n=1000, ci.alpha=0.95, stratified=FALSE, show.thres=TRUE, grid=TRUE)                          
...
AcceptROC <- roc(predictor=externalResults$predicted_exac_probability, response = externalResults$hadExac,
    plot = T, ci=T, print.auc=TRUE,  boot.n=1000, ci.alpha=0.95, stratified=FALSE, show.thres=TRUE, grid=TRUE)                          

HistoryROC <- roc(predictor=externalResults$obsExac_yr1, response = externalResults$hadExac,
                             plot = T, ci=T, print.auc=TRUE,  boot.n=1000, ci.alpha=0.95, stratified=FALSE, show.thres=TRUE, grid=TRUE)                          
